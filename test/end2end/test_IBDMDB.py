...
from ..TestsUtility import ENCODED_DATAMATRIX_DATAFRAME, SAMPLES_ID_COLUMN, TARGETS_COLUMN, CLASSES_DESIGN, \
    ENCODED_METADATA_DATAFRAME, SELECTED_MODELS
...
def test_givenIBDMDBDataset_whenLearning_thenNoThrow(input_controller):
    ...
    input_controller.set_data_matrix_from_path("data.csv", data=ENCODED_DATAMATRIX_DATAFRAME)
